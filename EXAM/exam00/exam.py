...
def get_top_student_with_credit_points(students: list, min_credit_points: int):
    ...
    for student in students:
        if student.credit_points > min_credit_points:
            ...
            if best_student == '' or student.average_grade > best_student.average_grade:
...
def get_ordered_students(students: list) -> list:
    ...
    """
    sorted_students = sorted(students, key=lambda student: (-student.credit_points, -student.average_grade, student.name), reverse=True)
